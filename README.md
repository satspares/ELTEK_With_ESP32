...
Added Eltek network ID change to new menu item.
...
The displays are from the DWIN Store on Aliexpress about 18.00usd plus carriage DMG48270C043_04WTC recommended.
